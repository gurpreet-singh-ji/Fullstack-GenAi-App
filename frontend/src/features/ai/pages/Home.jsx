...
const Home = () => {
    ...
    const { generateReport, loading,reports } = useAI()
            ...
            <div className='interview-card'>
                <div className='interview-card__body'>
                    ...
                    {error && (
                        <div className='error-banner'>
                            ...
                            <p>{error}</p>
                            <button type="button" onClick={() => setError("")} className='error-banner__close'>×</button>
                        </div>
                    )}
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='info-box'>
                            ...
                            <p>provide both  <strong>Resume</strong> and a <strong>Self Description</strong> to generate a personalized plan.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className='interview-card__footer'>
                    ...
                    <button
                        ...
                        disabled={loading || (!resumeInputRef.current?.files[0] && !selfDescription.trim()) || !jobDescription.trim()}
